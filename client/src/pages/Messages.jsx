  ...
  return (
    <div className='min-h-screen relative bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        {/* Title */}
        <div className='mb-8'>
          <h1 className='text-3xl font-bold tex-slate-900 mb-2'>Messages</h1>
        ...
        <div className='flex flex-col gap-3'>
          {dummyConnectionsData.map((user) => (
            <div key={user._id} className='max-w-xl flex flex-wrap gap-5 p-6 bg-white shadow rounded-md'>
              <img src={user.profile_picture} onClick={() => navigate(`/profile/${user._id}`)}className='rounded-full size-12 mx-auto cursor-pointer' />
