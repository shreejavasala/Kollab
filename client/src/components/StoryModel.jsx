...
const StoryModel = ({ setShowModel, fetchStories }) => {
  ...
  const bgColors = ["#22C55E", "#7c3aed", "#db2777", "#e11d48", "#ca8a04", "#0d9488"]
  ...
  const MAX_VIDEO_SIZE_MB = 50 // size in mb
    ...
    <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4'>
      <div className='w-full max-w-md'>
        ...
        <button onClick={() => toast.promise(handleCreateStory(), {
          loading: 'Saving...',
        })} className='flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-linear-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 active:scale-95 transition cursor-pointer'>
